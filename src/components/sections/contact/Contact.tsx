...
export default function Contact() {
    ...
    return(
        <div id="contact" className="h-fit scroll-mt-[10px] pb-30">
            <div className="h-22 w-auto pb-35 flex-col justify-center text-center items-center content-center text-white max-sm:pb-70 gsap-contacts-top">
            ...
            <div className="flex justify-center gap-40">
                <div className="h-auto w-[30%] min-w-[300px] flex flex-col gap-10 gsap-contacts-left">
                ...
                <div className="h-auto w-[30%] min-w-[500px] gsap-contacts-right">
                    <ContactMessage />
                </div>
            </div> 
        </div>
